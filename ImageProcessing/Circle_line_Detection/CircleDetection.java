...
public class CircleDetection {
    ...
    public CircleDetection(int numDrawnCircles, int threshold, int minRad, int maxRad ) throws Exception{
        //ensures all the file systems required are in order
        File originalFile = new File("HoughCircles3.png");
        ...
        //arguments are [Num Drawn Circles] [Sobel Threshold] [Minimum radius circle] [Max radius circle]
        CircleDetection.minRad = minRad;
        //this.numDrawnCircles=numDrawnCircles;
        CircleDetection.maxRad = maxRad;
        CircleDetection.threshold =threshold;
    ...
    static double[][] edgeDetection(double[][] grey) throws Exception{
    ...
    static List<CircleHit> circleDetection(double[][] sobelTotal) throws Exception {
