...
public class CircleHough {
		...
		static int height;
		static int[] acc;
		static int accSize=3;
		static int[] results;
		static int r;

		public static void CircleHough() {
			progress=0;
		}

		public static void init(int[] inputIn, int widthIn, int heightIn, int radius) {
			r = radius;
			width=widthIn;
			height=heightIn;
		...
		private static void setPixel(int value, int xPos, int yPos) {
			output[(yPos * width)+xPos] = 0x000000ff | (value << 16 | value << 8 | value);
		}
