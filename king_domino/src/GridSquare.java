    ...
    public void setColor() {
		if(NewGameSetUp.getPalette().equals("Color Palette1")){
			if(this.getName().equals("wheatFields")) {
				terrainImg=new ImageIcon("images/wheatfeilds.png");
				this.setIcon(terrainImg); 
			}
			if(this.getName().equals("forests")) {
				terrainImg=new ImageIcon("images/forest.png");
				this.setIcon(terrainImg);   
			}
			if(this.getName().equals("grassLands")) {
				terrainImg=new ImageIcon("images/grassLands.png");
				this.setIcon(terrainImg);  
			}
			if(this.getName().equals("lakes")) {
				terrainImg=new ImageIcon("images/lakes.png");
				this.setIcon(terrainImg);  
			}
			if(this.getName().equals("mines")) {
				terrainImg=new ImageIcon("images/mines.png");
				this.setIcon(terrainImg);  
			}
			if(this.getName().equals("swamp")) {
				terrainImg=new ImageIcon("images/swamp.png");
				this.setIcon(terrainImg);  
			}
		}
		if(NewGameSetUp.getPalette().equals("Color Palette2")){
			if(this.name.equals("wheatFields")) {
				terrainImg=new ImageIcon("images/wheatfeildsbw.jpg");
				this.setIcon(terrainImg);  
			}
			if(this.name.equals("forests")) {
				terrainImg=new ImageIcon("images/forestbw.jpg");
				this.setIcon(terrainImg); 			}
			if(this.name.equals("grassLands")) {
				terrainImg=new ImageIcon("images/grassLandsbw.jpg");
				this.setIcon(terrainImg);			}
			if(this.name.equals("lakes")) {
				terrainImg=new ImageIcon("images/lakesbw.jpg");
				this.setIcon(terrainImg);  
			}
			if(this.name.equals("mines")) {
				terrainImg=new ImageIcon("images/minesbw.jpg");
				this.setIcon(terrainImg);  
			}
			if(this.name.equals("swamp")) {
				terrainImg=new ImageIcon("images/swampbw.jpg");
				this.setIcon(terrainImg);  
			}
