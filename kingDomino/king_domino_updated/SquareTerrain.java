...
public class SquareTerrain extends JButton
{
    ...
    public SquareTerrain(double id)
    {
		...
		if(NewGameSetUp.getPalette().equals("Color Palette2")) {
			switch(this.getName()) {
	        case("wheatFieldsbw"):
	        	this.img=new ImageIcon(Class.class.getResource("wheatfeildsbw.png"));
	        case("forestsbw"):
	        	this.img=new ImageIcon(Class.class.getResource("forestbw.png"));
	        case("grassLandsbw"):
	        	this.img=new ImageIcon(Class.class.getResource("grassLandsbw.png"));
	        	
	        case("lakesbw"):
	        	this.img=new ImageIcon(Class.class.getResource("lakesbw.png"));
	        case("minesbw"):
	        	this.img=new ImageIcon(Class.class.getResource("minesbw.png"));
	        case("swampsbw"):
	        	this.img=new ImageIcon(Class.class.getResource("swampsbw.png"));
